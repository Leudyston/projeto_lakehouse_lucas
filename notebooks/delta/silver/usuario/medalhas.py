...
param = {
    ...
    "tabela_silver": "medalhas",
    "esquema_silver": "silver",
    "local_tabela_silver": "/mnt/silver/gerencial/medalhas"
}
...
df_ajusta_colunas = (
    df
        .withColumnRenamed("_Id", "ID_MEDALHA")
        .withColumnRenamed("_UserId", "ID_USUARIO")
        .withColumnRenamed("_Name", "NOME_MEDALHA")
        .withColumn("DATA", date_format(col("_Date"), "yyyy-MM-dd HH:mm:ss"))
        .withColumnRenamed("_TagBased", "BASEADO_TAG")
        .select("ID_MEDALHA", "ID_USUARIO", "NOME_MEDALHA", "DATA", "BASEADO_TAG")
)
