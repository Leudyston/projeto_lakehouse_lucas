...
param = {
    ...
    "tabela_silver": "usuarios",
    "esquema_silver": "silver",
    "local_tabela_silver": "/mnt/silver/gerencial/usuarios"
}
...
df_ajusta_colunas = (
    df
        .withColumnRenamed("_Id", "ID_USUARIO")
        .withColumnRenamed("_Reputation", "REPUTACAO")
        .withColumn("DT_CRIACAO", date_format(col("_CreationDate"), "yyyy-MM-dd HH:mm:ss"))
        .withColumnRenamed("_DisplayName", "NOME_EXIBICAO")
        .withColumn("DT_ULTIMO_ACESSO", date_format(col("_LastAccessDate"), "yyyy-MM-dd HH:mm:ss"))
        .withColumnRenamed("_Views", "VISUALIZACAO")
        .withColumnRenamed("_UpVotes", "VOTOS_PARA_CIMA")
        .withColumnRenamed("_DownVotes", "VOTOS_PARA_BAIXO")
        .withColumnRenamed("_ProfileImageUrl", "URL_IMAGEM_PERFIL")
        .select("ID_USUARIO", "REPUTACAO", "DT_CRIACAO", "NOME_EXIBICAO", "DT_ULTIMO_ACESSO", "VISUALIZACAO", "VOTOS_PARA_CIMA", "VOTOS_PARA_BAIXO", "URL_IMAGEM_PERFIL")
)
