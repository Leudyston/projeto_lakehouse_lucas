...
param = {
    "tabela_bronze": "post_links",
    "esquema_bronze": "bronze",
    "tabela_silver": "postagem_links",
    "esquema_silver": "silver",
    "local_tabela_silver": "/mnt/silver/gerencial/postagem_links"
}
...
df_ajusta_colunas = (
    df
        .withColumnRenamed("_Id", "ID_POSTAGEM_LINK")
        .withColumn("DT_CRIACAO", date_format(col("_CreationDate"), "yyyy-MM-dd HH:mm:ss"))
        .withColumnRenamed("_PostId", "ID_POSTAGEM")
        .withColumnRenamed("_RelatedPostId", "ID_POSTAGEM_RELACIONADA")
        .select("ID_POSTAGEM_LINK", "DT_CRIACAO", "ID_POSTAGEM", "ID_POSTAGEM_RELACIONADA")
)
