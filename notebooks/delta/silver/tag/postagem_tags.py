...
df_posts_seleciona_colunas = df_posts.select("ID_POSTAGEM", "TAGS", "PONTUACAO", "QTD_VISUALIZACAO", "QTD_RESPOSTA", "QTD_COMENTARIO", "QTD_FAVORITO")
...
df_posts_join_tags = (
    df_posts_separa_tags
        ...
        .select("ID_POSTAGEM", "ID_TAG", df_posts_separa_tags["NOME_TAG"], "PONTUACAO", "QTD_VISUALIZACAO", "QTD_RESPOSTA", "QTD_COMENTARIO", "QTD_FAVORITO")
)
