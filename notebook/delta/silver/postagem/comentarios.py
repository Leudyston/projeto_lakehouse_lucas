...
from pyspark.sql.functions import date_format, from_utc_timestamp, current_timestamp, date_format, col
from pyspark.sql.utils import AnalysisException

# COMMAND ----------

param = {
    "tabela_bronze": "comments",
    "esquema_bronze": "bronze",
    "tabela_silver": "comentarios",
    "esquema_silver": "silver",
    "local_tabela_silver": "/mnt/silver/gerencial/comentarios"
}
...
display(spark.sql("OPTIMIZE {esquema_silver}.{tabela_silver}".format(**param)))
