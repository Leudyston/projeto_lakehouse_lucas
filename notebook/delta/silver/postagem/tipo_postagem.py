...
param = {
    "tabela_bronze": "post_types",
    "esquema_bronze": "bronze",
    "tabela_silver": "tipo_postagem",
    "esquema_silver": "silver",
    "local_tabela_silver": "/mnt/silver/gerencial/tipo_postagem"
}
...
df_ajusta_colunas = ( df
        .withColumnRenamed("Id", "ID_TIPO_POSTAGEM")
        .withColumnRenamed("Name", "NOME_TIPO_POSTAGEM")
        .select('ID_TIPO_POSTAGEM', 'NOME_TIPO_POSTAGEM')
)
