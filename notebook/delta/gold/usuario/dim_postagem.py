...
param = {
    "tabela_gold": "dim_postagem",
    "esquema_gold": "gold",
    "coluna_sk": "SK_POSTAGEM",
    "local_tabela_gold": "/mnt/gold/usuario/dim_postagem"
}

# COMMAND ----------

df_silver_postagem = spark.table('silver.postagens')

# COMMAND ----------

# display(df_silver_postagem)

# COMMAND ----------

df_seleciona_colunas = df_silver_postagem.select('ID_POSTAGEM', 'ID_USUARIO_DONO', 'ID_TIPO_POSTAGEM', 'ID_RESPOSTA_ACEITA', 'ID_USUARIO_ULTIMO_EDITOR', 'TITULO', 'CORPO_TEXTO', 'DT_CRIACAO_POSTAGEM', 'DT_ULTIMA_EDICAO', 'DT_ULTIMA_ATIVIDADE').distinct().orderBy('ID_POSTAGEM')
